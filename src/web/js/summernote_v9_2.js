...
(function (global, factory) {
    ...
    var ui = {
        ...
        // 带颜色的按钮
        buttonColor: function ($node, options) {
            return renderer.create('<button type="button" class="note-btn btn btn-default btn-sm" tabindex="-1">', function ($node, options) {
                if (options && options.tooltip) {
                    $node.attr({
                        title: options.tooltip
    ...
    */
    ...
    var Buttons = /** @class */ (function () {
        ...
        Buttons.prototype.buttonColor = function (o) {
            if (!this.options.tooltip && o.tooltip) {
                delete o.tooltip;
            }
            o.container = this.options.container;
            return this.ui.buttonColor(o);
        };
                ...
                children: [
                    ...
                    this.ui.dropdown({
                        items: (backColor ? [
                            ...
                            '    <button type="button" class="note-color-select btn paigusu" data-event="openPalette" data-value="backColorPicker">',
                            ...
                            (foreColor ? [
                                ...
                                '  <div class="colorFont planButton">',
                                '    <button type="button" class="note-color-select btn paigusu" data-event="openPalette" data-value="foreColorPicker">',
                        ...
                        click: function (event) {
                            ...
                            if (eventName === 'openPalette') {
                                if (!$(".planPoa")) {
                                    $('.note-palette').append('<div class="planPoa"></div>')
                                }
    ...
    $$1.summernote = $$1.extend($$1.summernote, {
        ...
        options: {
            ...
            // Foreground/background colors in different themes
            // Using rgba instead of HEX helps to replace colors when switching themes,
            // sa index.js switchTextColor()
