...
static const QString htmlHead =
    ...
    "<style>"
    "body { font-family: 'Helvetica'; font-size: 14px; padding: 0px; line-height: 1.7; max-width: 780px; margin: 0 auto; }"
    ...
    ".li { background: rgba(0, 0, 0, 0.05); min-height: 30px; border-radius: 8px; margin-bottom: 10px; margin-top: 10px; }"
