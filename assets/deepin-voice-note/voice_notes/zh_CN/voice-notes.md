...
- 当第一次新建记事本后，系统默认创建一个笔记，在笔记列表内单击 ![add](../common/circlebutton_add2.svg) 按钮可继续创建新的笔记。
...
1. 在语音记事本界面上，选择一个笔记。
2. 在右侧详情页内单击 ![record_normal](../common/record_normal.svg)，添加语音。
3. 单击 ![finish](../common/finish_normal.svg) 按钮完成语音录制。
   
   > ![notes](../common/notes.svg)说明：添加语音的过程中您可以单击 ![pause](../common/pause_red_normal.svg) 按钮暂停录音，再次单击 ![record_normal](../common/record_normal.svg) 按钮继续录音。录音的限制时长为60分钟。
3. 录制完成后，单击 ![play_blue_normal](../common/play_blue_normal.svg) 播放按钮可以回放语音。
...
- 按住鼠标左键将笔记拖拽到另一个记事本中。
- 单击鼠标左键选择 **移动**，在弹出的对话框中选择一个记事本，单击 **确定**，该笔记会移到所选的记事本中。
