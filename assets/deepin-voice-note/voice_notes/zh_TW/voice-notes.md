# 語音記事本|../common/deepin_voice_note_96.svg|

## 概述

語音記事本是一款設計簡潔、美觀易用的集文字、錄音來記事的軟體。
...
2. 上下滾動滑鼠滾輪瀏覽或透過搜尋，找到語音記事本 ![deepin_voice_note](../common/deepin_voice_note.svg)點擊執行。
...
> ![notes](../common/notes.svg)說明：如果語音記事本已經預設固定在Dock中，您也可以點擊Dock中的 ![deepin_voice_note](../common/deepin_voice_note.svg)來執行。

### 關閉語音記事本

- 在語音記事本介面點擊 ![close_icon](../common/close_icon.svg)，關閉語音記事本。
- 在任務欄右鍵單擊 ![deepin_voice_note](../common/deepin_voice_note.svg)，選擇 **全部關閉** 來關閉語音記事本。
- 在語音記事本介面點擊 ![icon_menu](../common/icon_menu.svg)，選擇 **離開** 來關閉語音記事本。

### 查看快捷鍵

在語音記事本介面上，按下鍵盤上的 **Ctrl + Shift + ?** 組合鍵來查看快捷鍵，熟練的使用快捷鍵，將大大提升您的操作效率。
...
- 當語音記事本中尚無記事本時，點擊 **建立記事本**，建立一個新的記事本。
- 在記事本列表下方，單擊 **建立記事本**，建立一個新的記事本。

![tips](../common/tips.svg)竅門：您可以在記事本列表中拖曳記事本來調整順序。

### 建立筆記

- 當第一次建立記事本後，系統預設建立一個筆記，在筆記列表內單擊 ![add](../common/circlebutton_add2.svg) 按鈕可繼續建立新的筆記。
- 右鍵單擊記事本或筆記，選擇 **建立筆記** 來建立一個新筆記。
...
1. 在語音記事本頂部搜尋框中，點擊 ![search](../common/search.svg)，輸入關鍵字。
2. 按下鍵盤上的 **Enter** 鍵後快速定位。
3. 在搜尋文字框中點擊 ![0|three_dots](../common/close_icon.svg) 清除目前輸入的關鍵字或取消搜尋。
...
- 按住滑鼠左鍵將筆記拖曳到另一個記事本中。
- 單擊滑鼠左鍵選擇 **移動**，在彈出的對話框中選擇一個記事本，單擊 **確定**，該筆記會移到所選的記事本中。
...
2. 在語音朗讀的狀態下，右鍵單擊選擇 **停止朗讀** 或者單擊左鍵停止朗讀。
...
1. 在語音記事本介面選中一段文字。
2. 單擊滑鼠右鍵選擇 **文字翻譯**，選中的文字將被翻譯成目標語言。
...
1. 在語音記事本介面，點擊 ![icon_menu](../common/icon_menu.svg)。
2. 點擊 **主題**，選擇一個主題顏色。
