...
- 当第一次新建记事本后，系统默认创建一个笔记，在笔记列表内单击添加按钮 ![add](../common/circlebutton_add2.svg) 可继续创建新的笔记。
...
1. 在语音记事本界面上，选择一个笔记。
2. 单击录音按钮 ![record_normal](../common/record_normal.svg)，添加语音。
3. 单击完成按钮 ![finish](../common/finish_normal.svg) ，结束语音录制。
