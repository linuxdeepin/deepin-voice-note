...
test('themeProvided writes CSS variables on document root', () => {
  ...
  assert.equal(document.documentElement.style.getPropertyValue('--dvn-title-fg'), 'rgba(192, 198, 212, 1)')
  assert.equal(document.documentElement.style.getPropertyValue('--dvn-placeholder-fg'), 'rgba(109, 124, 136, 1)')
...
test('themeProvided: light theme variables', () => {
  ...
  assert.equal(document.documentElement.style.getPropertyValue('--dvn-title-fg'), 'rgba(0, 0, 0, 0.30)')
  assert.equal(document.documentElement.style.getPropertyValue('--dvn-placeholder-fg'), 'rgba(0, 0, 0, 0.30)')
